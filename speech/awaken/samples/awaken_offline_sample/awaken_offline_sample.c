...
{
	int         ret       = MSP_SUCCESS;
	//const char *lgi_param = "appid = 594fa2d3,work_dir = .";
	//const char *ssb_param = "ivw_threshold=0:1450,sst=wakeup,ivw_res_path =fo|res/ivw/wakeupresource.jet";
	const char *lgi_param = "appid = 37dda80c,work_dir = .";
	const char *ssb_param = "ivw_threshold=0:1450,sst=wakeup,ivw_res_path =fo|res/ivw/wakeupresource.jet";

	init_sound_capture();  // 对声卡进行初始化
